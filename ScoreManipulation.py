...
'''
def get_staff_cc(formatted_img, sep_function = staff_separation, pkl = "no", pkl_name = None):
...
def generate_score(score, staff_list, alter_func):
	...
	while i < len(staff_list):
		...
		altered_system = alter_func(system_features)
